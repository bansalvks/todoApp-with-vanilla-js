...
"use strict";var TodoUiService={renderTasks:function(a,e,r,o,u){a.innerHTML="",e.forEach(function(e){var n=document.createElement("button"),t=document.createElement("input");t.setAttribute("type","checkbox"),t.checked=e.isDone;var i=document.createElement("button");n.innerHTML="Edit",i.innerHTML="Remove";var d=document.createElement("input");d.value=e.text;var c=document.createElement("li");c.appendChild(t),c.appendChild(d),c.appendChild(n),c.appendChild(i),n.addEventListener("click",function(){r(e.id,d.value)}.bind(this)),i.addEventListener("click",function(){o(e.id)}.bind(this)),t.addEventListener("change",function(){u(e.id,t.checked)}.bind(this)),a.appendChild(c)})}};
"use strict";var newTaskInput=null,addTaskButtonElement=null,todoListUl=null,todoService=new TodoServices,updateTaskHandler=function(e,t){console.log(event),todoService.update(e,t)},deleteTaskHandler=function(e){todoService.remove(e)},doneTaskHandler=function(e,t){console.log(t),todoService.update(e,void 0,t)},onTodoListDataChange=function(){var e=todoService.getAll();TodoUiService.renderTasks(todoListUl,e,updateTaskHandler,deleteTaskHandler,doneTaskHandler)};todoService.addEventListener(onTodoListDataChange);var addTaskButtonClicked=function(e){console.log("Add New Task Button Clicked");var t=newTaskInput.value,n=new TaskModel(t,!1);todoService.add(n),newTaskInput.value=""};function DOMContentLoadedCallback(e){addTaskButtonElement=document.getElementById("addTaskButton"),newTaskInput=document.getElementById("newTaskInput"),todoListUl=document.getElementById("todoListUl"),addTaskButtonElement.addEventListener("click",addTaskButtonClicked),onTodoListDataChange(),document.removeEventListener("DOMContentLoaded",DOMContentLoadedCallback)}document.addEventListener("DOMContentLoaded",DOMContentLoadedCallback);